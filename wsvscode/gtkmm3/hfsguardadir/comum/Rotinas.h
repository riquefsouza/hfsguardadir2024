...
public:
	...
	static Glib::ustring formataDate(const Glib::ustring formato, const Glib::DateTime dt);
	static Glib::DateTime StringToDate(const Glib::ustring sData);
	static Glib::DateTime DataHoraNow();
	static Glib::DateTime RawToDataHora(const time_t rawTempo);
