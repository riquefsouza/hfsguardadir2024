...
const Glib::ustring DiretorioBO::SQL_CONSULTA_ARQUIVO = "select aba, cod, " \
...
std::vector<Diretorio> DiretorioBO::carregarDiretorio(
        const Glib::ustring &sSQL, IProgressoLog progressoLog) {
    return DiretorioDAO::getInstancia()->consultarTudo(sSQL, "", progressoLog);
}

std::vector<Diretorio> DiretorioBO::carregarDiretorio(const Glib::ustring &sSQL,
...
Glib::ustring DiretorioBO::removerDrive(const Glib::ustring &sDiretorio) {
	Glib::ustring sArq = sDiretorio;
	Glib::ustring drive = ":";
	bool bAchou = false;
...
int DiretorioBO::retCodDirPai(int nAba, const Glib::ustring &sDiretorio,
...
void DiretorioBO::ImportarDiretorio(int nAba, int nCodDirRaiz,
	...
	Arquivo info;
    Glib::ustring sCaminho, sSeparador, arquivo = "";
	...
	std::vector<Glib::ustring> listaDir = Rotinas::cListarArquivosDiretorios(sDiretorio);
...
bool DiretorioBO::verificaCodDir(int nAba, const Glib::ustring &sDiretorio,
        const std::vector<Diretorio>  &listaLocal) {
...
Glib::ustring DiretorioBO::diretorioToSQL(Diretorio diretorio, bool bInsert) {
    Glib::ustring sSQL = "";
	Glib::ustring stipo;
...
void DiretorioBO::salvarDiretorio(const std::vector<Diretorio>  &listaDiretorio,
    ...
    pb.passo = 1;
	pb.log = "";
	Glib::ustring sdir = Rotinas::getRecurso("TipoLista.diretorio");
...
bool DiretorioBO::excluirDiretorio(Aba aba, const Glib::ustring &sCaminho) {
...
Glib::ustring DiretorioBO::diretorioToCSV(Diretorio diretorio) {
    Glib::ustring sCSV = "\"";
...
Glib::ustring DiretorioBO::diretorioToXML(Diretorio diretorio) {
    Glib::ustring sXML, sCR, sTAB, sTAB2;
...
Glib::ustring DiretorioBO::diretorioToTXT(Diretorio diretorio) {
    Glib::ustring sTXT, sTAB;
...
Glib::ustring DiretorioBO::diretorioToHTML(Diretorio diretorio) {
    Glib::ustring sHTML, sCR, sTAB, sTAB2;
...
void DiretorioBO::exportarDiretorio(TipoExportar tipo, Aba aba,
    ...
    Glib::ustring sTexto = "", sCR, sTAB, sTAB2, sSQL, sCondicaoTotal;
    Aba abaLocal;
...
int DiretorioBO::XMLParaDiretorio(const Glib::ustring &sTexto, int nArquivo,
        DiretorioXML *diretorioXML) {
	Glib::ustring sTagInicio = "";
	Glib::ustring sValor = "";
	Glib::ustring sTagFim = "";
    int resultado;
...
int DiretorioBO::importarDiretorioViaXML(Aba aba, const Glib::ustring &sNomeArquivo,
        const std::vector<Diretorio>  &listaDirPai,
        IProgressoLog progressoLog) {
    Glib::ustring sTexto, sTexto1;
	...
	Glib::ustring item0 = listalocal.at(0);
...
bool DiretorioBO::carregarSubDiretorios(const Glib::ustring &sDiretorio,
	std::vector<Glib::ustring> &listaLocal) {
    Glib::ustring sCaminho, sSeparador, arquivo;
...
bool DiretorioBO::carregarArquivos(const Glib::ustring &sDiretorio,
        std::vector<Glib::ustring> &listaLocal) {
    Glib::ustring sCaminho, sSeparador, arquivo;
...
bool DiretorioBO::carregarTodosArquivos(const Glib::ustring &sDiretorio,
        std::vector<Glib::ustring> &listaLocal) {
	Glib::ustring sCaminho, sSeparador, arquivo;
	Glib::ustring ponto = ".";
	Glib::ustring pponto = "..";
