...
Glib::ustring AbaBO::abaToSQL(Aba aba) {
	Glib::ustring sql = "insert into Abas(cod, nome) values(";
	sql += aba.getCodigo() + "," +
...
Aba* AbaBO::pegaAbaPorNome(const std::vector<Aba> &lista, const Glib::ustring &nome) {
	Aba *aba = new Aba();
