...
FrmCompararDiretorio::FrmCompararDiretorio()
	...
	labDiferencasEncontradas->set_label("Diferenças Encontradas");
	...
	label6->set_label("<b>Diretório 2</b>");
	...
	labDiretorio1->set_label("<b>Diretório 1</b>");
	...
	btnCompararDiretorios->set_label("Comparar Diretórios");
	...
	this->set_title("Comparar Diretórios");
	...
	getLabStatus1()->set_text("Total de diferenças encontradas:");
