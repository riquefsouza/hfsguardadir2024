...
FrmInfoDiretorio::FrmInfoDiretorio()
	...
	colunaInfoDescricao = manage(new class Gtk::TreeViewColumn("Descrição", modeloTabelaInfo.coluna1));
	colunaInfoDescricao->set_resizable(true);
	colunaInfoDescricao->set_sizing(Gtk::TREE_VIEW_COLUMN_AUTOSIZE);
	colunaInfoDescricao->set_title("Descrição");
	...
	labLegendaDiretorio->set_label("[DIR] - Diretório");
	...
	this->set_title("Informações do Diretório / Arquivo");
