...
FrmPrincipal::FrmPrincipal()
	...
	menuMostrarOcultarArvoreDirAbaAtiva->set_label("Mostrar/Ocultar árvore de diretórios da Aba Ativa");
	...
	menuGravarLogImportacao->set_label("Gravar Log da Importação");
	...
	menuImportarDiretoriosViaXML->set_label("Importar Diretórios via XML");
	...
	menuExportarDiretoriosAbaAtiva->set_label("Exportar Diretórios da Aba Ativa");
	...
	menuColapsarDiretorios->set_label("Colapsar Diretórios");
	...
	menuExpandirDiretorios->set_label("Expandir Diretórios");
	...
	menuCadastrarExtensaoArquivo->set_label("Cadastrar Extensão de Arquivo");
	...
	menuCompararDiretorios->set_label("Comparar Diretórios");
	...
	menuImportarSubDiretorios->set_label("Importar SubDiretórios");
	...
	menuImportarDiretorio->set_label("Importar Diretório");
	...
	menuDiretorio->set_label("Diretório");
	...
	this->set_title("HFSGuardaDiretorio 2.0 - Catalogador de Diretórios");
...
/*
void FrmPrincipal::on_notebook1_switch_page(GtkWidget* page, guint page_num) {
	if (frmPrincipal != NULL) {
