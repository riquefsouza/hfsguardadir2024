...
/*
int Dialogo::MsgDlg(Gtk::Window* pai, const gchar *sTitulo,
...
void Dialogo::mensagemErro2(Gtk::Window* pai, const char* recurso, const std::string &texto) {
...
std::string Dialogo::entrada2(Gtk::Window* pai, const char* recurso,
	const std::string &valorInicial) {
	std::string titulo, rotulo, texto;
...
std::string Dialogo::entrada(Gtk::Window* pai, const char* recurso) {
