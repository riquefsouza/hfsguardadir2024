...
FrmPrincipal::FrmPrincipal()
	...
	*/
	...
	/*
	menuGravarLogImportacao = manage(new class GtkCheckMenuItem());
...
Gtk::Label* FrmPrincipal::getLabStatus1() {
	...
	GtkFrame* frameStatus1 = static_cast<GtkFrame*>(lista.at(0));
...
void FrmPrincipal::on_notebook1_switch_page(GtkNotebook* page, guint page_num) {	
	if (frmPrincipal != NULL) {
